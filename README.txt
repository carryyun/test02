...
[ * 해결해야할 문제* ]
 - *해결필요* 리스트의 아이템 삭제기능
 - *해결필요* 체결량을 일정주기마다 초기화 시켜줘야 추세의 변화가 더 확실하게 보일 것 같음.
 - *해결필요* 차트가 조회 시점까지의 정보만 출력되므로 실시간정보도 추가 필요할 것 같음.
 - *해결필요* 체결내역ID 맵으로 변경해야하는이유 => 코인별로 리스트를 따로 사용하게 해야 정확하게 구분이 가능함.
 - *해결필요* 검색 기능 완성시켜야함
 - *해결필요* 

 - *해결필요* 임시방편으로 if BTC || price>1000000 을 사용해서 작동은 시켜놨으나 수정해야 할지도..?
 - *해결필요* 마켓뎁스까지 추가할지?
 - *해결필요* *마지막작업* js를 분리시켜야할 것 같고, 또한 서비스, 컨트롤러에서 해결할 수 있는 문제들도 js에서 분리시켜야 할 것같음.
