...
//[21-05-04] **DAO를 대문자로 안써서 에러가 떴었음.
@MapperScan("yun.cms.dao")
@PropertySource("classpath:/yun/cms/conf/security.properties")
...
public class AppConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource,
        ...
        System.out.println("sqlSessionFacktory 객체 생성");
        ...
        try {
            ...
            factory.setTypeAliasesPackage("yun.cms.dto");
            
            // SQL 맵퍼 파일 경로를 등록한다.
            factory.setMapperLocations(appCtx.getResources("classpath:/yun/cms/mapper/**/*.xml") );
