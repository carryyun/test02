...
//[21-05-06] 맵으로 변경해야하는이유 => 코인별로 리스트를 따로 사용하게 해야 정확하게 구분이 가능함.
...
function burn(){
	...
	for(let i=1; i<cnt; i++){
		...
		console.log("c.totalVolume"+c.totalVolume);
		console.log("c.bidVolume"+c.bidVolume);
